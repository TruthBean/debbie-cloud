 ...
 * @since 0.6.3
 */
public class ShiroModuleStarter implements DebbieModuleStarter {

    private static final String ENABLE_KEY = "debbie.shiro.enable";
    ...
    public void registerBean(ApplicationContext applicationContext, BeanInfoManager beanInfoManager) {
        DebbieReflectionBeanFactory<ShiroConfiguration> debbieBeanInfo =
                new DebbieReflectionBeanFactory<>(ShiroConfiguration.class);
        debbieBeanInfo.addBeanName("shiroConfiguration", ShiroConfiguration.class.getName());
    ...
    public void starter(ApplicationContext applicationContext) {
        ...
        ShiroConfiguration configuration = factory.factory(ShiroConfiguration.class);
        ShiroSecurityManagerFactory securityManagerFactory = new ShiroSecurityManagerFactory(configuration);
        var beanFactory = new SimpleBeanFactory<>(securityManagerFactory, ShiroSecurityManagerFactory.class);
    ...
    public void release(ApplicationContext applicationContext) {
        var factory = applicationContext.getGlobalBeanFactory();
        ShiroSecurityManagerFactory securityManagerFactory = factory.factory(ShiroSecurityManagerFactory.class);
