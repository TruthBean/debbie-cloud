 ...
 * @since 0.6.3
 */
public class TomcatJdbcModuleStarter implements DebbieModuleStarter {

    private static final String ENABLE_KEY = "debbie.tomcat-jdbc.enable";
    ...
    public void registerBean(ApplicationContext applicationContext, BeanInfoManager beanInfoManager) {
        beanInfoManager.registerBeanInfo(new PropertiesConfigurationBeanFactory<>(new TomcatJdbcProperties(), TomcatJdbcConfiguration.class));
    }
