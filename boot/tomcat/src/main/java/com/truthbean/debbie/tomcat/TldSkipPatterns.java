...
class TldSkipPatterns {
    ...
    static {
        stringBuilder
            .append("idea_rt.jar").append(",")
            .append("opentest4j-*.jar").append(",")
            .append("apiguardian-api-*.jar").append(",")
            .append("jakarta.servlet.jsp.jstl-*.jar").append(",")
            .append("ant-*.jar").append(",")
            .append("asm-*.jar").append(",")
            .append("stax2-api-*.jar").append(",")
            .append("common-mini-*.jar").append(",")
            .append("debbie-core-*.jar").append(",")
            .append("debbie-mvc-*.jar").append(",")
            .append("debbie-server-*.jar").append(",")
            .append("transformer-*.jar").append(",")
            ...
            .append("debbie-test-*.jar").append(",")
            .append("httpclient*.jar").append(",")
            .append("log4j-*.jar").append(",")
            .append("log4j2-boot-*.jar").append(",")
            .append("logger-core-*.jar").append(",")
            .append("logger-to-log4j2-*.jar").append(",")
            ...
            .append("tomcat-embed-websocket-*.jar").append(",")
            .append("tomcat-embed-jasper-*.jar").append(",")
            .append("tomcat-annotations-api-*.jar").append(",")
