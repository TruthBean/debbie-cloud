package com.truthbean.debbie.c3p0.check;
...
public class C3p0DataSourcesTest {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(C3p0DataSourcesTest.class);
}
