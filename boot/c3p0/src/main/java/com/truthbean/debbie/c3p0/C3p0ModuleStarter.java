 ...
 * @since 0.6.3
 */
public class C3p0ModuleStarter implements DebbieModuleStarter {

    private static final String ENABLE_KEY = "debbie.c3p0.enable";
    ...
    public void registerBean(ApplicationContext applicationContext, BeanInfoManager beanInfoManager) {
        beanInfoManager.registerBeanInfo(new PropertiesConfigurationBeanFactory<>(new C3p0Properties(), C3p0Configuration.class));
    }
