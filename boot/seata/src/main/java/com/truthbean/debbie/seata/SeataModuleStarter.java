...
public class SeataModuleStarter implements DebbieModuleStarter {
    ...
    public void registerBean(ApplicationContext applicationContext, BeanInfoManager beanInfoManager) {
        DebbieReflectionBeanFactory<SeataConfiguration> debbieBeanInfo =
                new DebbieReflectionBeanFactory<>(SeataConfiguration.class);
        debbieBeanInfo.addBeanName("seataConfiguration", SeataConfiguration.class.getName());
    ...
    public void release(ApplicationContext applicationContext) {
        var factory = applicationContext.getGlobalBeanFactory();
        SeataTransactionFactory transactionFactory = factory.factory(SeataTransactionFactory.class);
