 ...
 * @since 0.6.3
 */
public class GrpcClientModuleStarter implements DebbieModuleStarter {

    private static final String ENABLE_KEY = "debbie.grpc.client.enable";
    ...
    public void registerBean(ApplicationContext applicationContext, BeanInfoManager beanInfoManager) {
        DebbieReflectionBeanFactory<GrpcClientConfiguration> debbieBeanInfo =
                new DebbieReflectionBeanFactory<>(GrpcClientConfiguration.class);
        debbieBeanInfo.addBeanName("grpcClientConfiguration", GrpcClientConfiguration.class.getName());
    ...
    public void starter(ApplicationContext applicationContext) {
        ...
        GrpcClientConfiguration configuration = factory.factory(GrpcClientConfiguration.class);
        GrpcClientFactory clientFactory = new GrpcClientFactory(configuration);
        var beanFactory = new SimpleBeanFactory<>(clientFactory, GrpcClientFactory.class);
    ...
    public void release(ApplicationContext applicationContext) {
        var factory = applicationContext.getGlobalBeanFactory();
        GrpcClientFactory clientFactory = factory.factory(GrpcClientFactory.class);
