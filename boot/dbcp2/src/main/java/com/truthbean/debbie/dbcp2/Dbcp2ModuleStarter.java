 ...
 * @since 0.6.3
 */
public class Dbcp2ModuleStarter implements DebbieModuleStarter {

    private static final String ENABLE_KEY = "debbie.dbcp2.enable";
    ...
    public void registerBean(ApplicationContext applicationContext, BeanInfoManager beanInfoManager) {
        beanInfoManager.registerBeanInfo(new PropertiesConfigurationBeanFactory<>(new Dbcp2Properties(), Dbcp2Configuration.class));
    }
