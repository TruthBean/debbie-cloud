package com.truthbean.debbie.dbcp2.check;
...
public class Dbcp2DataSourcesTest {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(Dbcp2DataSourcesTest.class);
}