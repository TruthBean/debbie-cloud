 ...
 * @since 0.6.3
 */
public class RedissonModuleStarter implements DebbieModuleStarter {

    private static final String ENABLE_KEY = "debbie.redisson.enable";
    ...
    public void registerBean(ApplicationContext applicationContext, BeanInfoManager beanInfoManager) {
        DebbieReflectionBeanFactory<RedissonConfiguration> debbieBeanInfo =
                new DebbieReflectionBeanFactory<>(RedissonConfiguration.class);
        debbieBeanInfo.addBeanName("redissonConfiguration", RedissonConfiguration.class.getName());
    ...
    public void starter(ApplicationContext applicationContext) {
        ...
        RedissonConfiguration configuration = factory.factory(RedissonConfiguration.class);
        RedissonClientFactory clientFactory = new RedissonClientFactory(configuration);
        var beanFactory = new SimpleBeanFactory<>(clientFactory, RedissonClientFactory.class);
    ...
    public void release(ApplicationContext applicationContext) {
        var factory = applicationContext.getGlobalBeanFactory();
        RedissonClientFactory clientFactory = factory.factory(RedissonClientFactory.class);
