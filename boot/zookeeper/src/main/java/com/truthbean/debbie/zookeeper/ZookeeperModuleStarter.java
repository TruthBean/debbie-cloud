 ...
 * @since 0.6.3
 */
public class ZookeeperModuleStarter implements DebbieModuleStarter {

    private static final String ENABLE_KEY = "debbie.zookeeper.enable";
    ...
    public void registerBean(ApplicationContext applicationContext, BeanInfoManager beanInfoManager) {
        DebbieReflectionBeanFactory<ZookeeperConfiguration> debbieBeanInfo =
                new DebbieReflectionBeanFactory<>(ZookeeperConfiguration.class);
        debbieBeanInfo.addBeanName("zookeeperConfiguration", ZookeeperConfiguration.class.getName());
    ...
    public void starter(ApplicationContext applicationContext) {
        ...
        ZookeeperConfiguration configuration = factory.factory(ZookeeperConfiguration.class);
        ZookeeperClientFactory clientFactory = new ZookeeperClientFactory(configuration);
        var beanFactory = new SimpleBeanFactory<>(clientFactory, ZookeeperClientFactory.class);
    ...
    public void release(ApplicationContext applicationContext) {
        var factory = applicationContext.getGlobalBeanFactory();
        ZookeeperClientFactory clientFactory = factory.factory(ZookeeperClientFactory.class);
