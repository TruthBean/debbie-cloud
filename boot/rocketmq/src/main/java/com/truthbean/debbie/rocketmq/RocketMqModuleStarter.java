 ...
 * @since 0.6.3
 */
public class RocketMqModuleStarter implements DebbieModuleStarter {

    private static final String ENABLE_KEY = "debbie.rocketmq.enable";
    ...
    public void registerBean(ApplicationContext applicationContext, BeanInfoManager beanInfoManager) {
        DebbieReflectionBeanFactory<RocketMqConfiguration> debbieBeanInfo =
                new DebbieReflectionBeanFactory<>(RocketMqConfiguration.class);
        debbieBeanInfo.addBeanName("rocketMqConfiguration", RocketMqConfiguration.class.getName());
    ...
    public void starter(ApplicationContext applicationContext) {
        ...
        RocketMqConfiguration configuration = factory.factory(RocketMqConfiguration.class);
        RocketMqClientFactory clientFactory = new RocketMqClientFactory(configuration);
        var beanFactory = new SimpleBeanFactory<>(clientFactory, RocketMqClientFactory.class);
    ...
    public void release(ApplicationContext applicationContext) {
        var factory = applicationContext.getGlobalBeanFactory();
        RocketMqClientFactory clientFactory = factory.factory(RocketMqClientFactory.class);
