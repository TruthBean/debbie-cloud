 ...
 * @since 0.6.3
 */
public class RabbitMqModuleStarter implements DebbieModuleStarter {

    private static final String ENABLE_KEY = "debbie.rabbitmq.enable";
    ...
    public void registerBean(ApplicationContext applicationContext, BeanInfoManager beanInfoManager) {
        DebbieReflectionBeanFactory<RabbitMqConfiguration> debbieBeanInfo =
                new DebbieReflectionBeanFactory<>(RabbitMqConfiguration.class);
        debbieBeanInfo.addBeanName("rabbitMqConfiguration", RabbitMqConfiguration.class.getName());
    ...
    public void starter(ApplicationContext applicationContext) {
        ...
        RabbitMqConfiguration configuration = factory.factory(RabbitMqConfiguration.class);
        RabbitMqClientFactory clientFactory = new RabbitMqClientFactory(configuration);
        var beanFactory = new SimpleBeanFactory<>(clientFactory, RabbitMqClientFactory.class);
    ...
    public void release(ApplicationContext applicationContext) {
        var factory = applicationContext.getGlobalBeanFactory();
        RabbitMqClientFactory clientFactory = factory.factory(RabbitMqClientFactory.class);
