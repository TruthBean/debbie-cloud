 ...
 * @since 0.6.3
 */
public class PulsarModuleStarter implements DebbieModuleStarter {

    private static final String ENABLE_KEY = "debbie.pulsar.enable";
    ...
    public void registerBean(ApplicationContext applicationContext, BeanInfoManager beanInfoManager) {
        DebbieReflectionBeanFactory<PulsarConfiguration> debbieBeanInfo =
                new DebbieReflectionBeanFactory<>(PulsarConfiguration.class);
        debbieBeanInfo.addBeanName("pulsarConfiguration", PulsarConfiguration.class.getName());
    ...
    public void starter(ApplicationContext applicationContext) {
        ...
        PulsarConfiguration configuration = factory.factory(PulsarConfiguration.class);
        PulsarClientFactory clientFactory = new PulsarClientFactory(configuration);
        var beanFactory = new SimpleBeanFactory<>(clientFactory, PulsarClientFactory.class);
    ...
    public void release(ApplicationContext applicationContext) {
        var factory = applicationContext.getGlobalBeanFactory();
        PulsarClientFactory clientFactory = factory.factory(PulsarClientFactory.class);
